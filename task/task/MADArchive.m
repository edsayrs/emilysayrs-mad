...
//define 4 constants for our four tasks 
...
//method from delegate protocol, takes NSCoder object as a parameter, and it encodes it. call encodeObject: forKey:
...
//use to decode objects, use initWith: method, takes an NSCoder object, then return it so you are sending back the object
...
//creates a new object, copies the 4 strings into it. alloc with a zone, deals with memory zones, needed for NSCopy.
//returns an object that can be used because it has been decoded. 
